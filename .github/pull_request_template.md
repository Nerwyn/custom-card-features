...
- [ ] I've followed [the README contributing guidelines](https://github.com/Nerwyn/custom-card-features/blob/main/CONTRIBUTING.md) and ensured that pre-commit and build ran correctly.
